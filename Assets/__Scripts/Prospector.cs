...
public class Prospector : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (go != null)
        {
            UIGameOver = go.GetComponent<Text>();
        }
        go = GameObject.Find("RoundResult");
        if (go != null)
        {
            UIRoundResult = go.GetComponent<Text>();
        }
        // Make them invisible
        ShowResultGTs(false);
    ...
    {
        UIGameOver.gameObject.SetActive(show);
        UIRoundResult.gameObject.SetActive(show);
    }
    ...
    void ScoreManager(ScoreEvent sEvt)
    {
        ...
        switch (sEvt)
        {
            case ScoreEvent.gameWin:
                ...
                UIRoundResult.text = "You won this round!\nRound Score: " + score;
                ShowResultGTs(true);
                break;
            case ScoreEvent.gameLoss:
                ...
                if (Prospector.HIGH_SCORE <= score)
                {
                    ...
                    UIRoundResult.text = sRR;
                    Prospector.HIGH_SCORE = score;
                    PlayerPrefs.SetInt("ProspectorHighScore", score);
                }
                else
                {
                    UIRoundResult.text = "Your final score was: " + score;
